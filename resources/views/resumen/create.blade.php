                ...
                <div class="form-group full">
                    ...
                    <select id="audiencias_id" name="audiencias_id" required>
                        ...
                        @foreach($audiencias as $audiencia)
                            ...
                            @endphp
                            <option value="{{ $audiencia->id }}" {{ old('audiencias_id') == $audiencia->id ? 'selected' : '' }}>
                                #{{ $audiencia->id }} - {{ optional($audiencia->fecha)->format('Y-m-d') }} - {{ $audiencia->causa }}{{ $imputados ? ' - ' . $imputados : '' }}
                            </option>
                        @endforeach
                    </select>
                    @error('audiencias_id')
